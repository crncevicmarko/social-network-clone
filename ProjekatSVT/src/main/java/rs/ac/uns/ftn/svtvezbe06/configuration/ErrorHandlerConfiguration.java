...
import rs.ac.uns.ftn.svtvezbe06.exceptionhandling.ErrorObject;
...
public class ErrorHandlerConfiguration {
    ...
    @ResponseBody
    ErrorObject handleIllegalArgumentException(HttpServletRequest request, IllegalArgumentException ex) {
        return new ErrorObject(request, ex.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    @ResponseBody
    ErrorObject handleEntityNotFoundException(HttpServletRequest request, EntityNotFoundException ex) {
        return new ErrorObject(request, ex.getMessage(), HttpStatus.NOT_FOUND);
    }
    ...
    @ResponseBody
    ErrorObject handleMalformedQueryException(HttpServletRequest request, MalformedQueryException ex) {
        return new ErrorObject(request, ex.getMessage(), HttpStatus.NOT_FOUND);
    }
}
